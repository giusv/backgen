...
;; (defun sco4-true (&key id days occurrences delay interval date)
;;   (tl-and (tl-exists (sini gv-ind-stat-sini) 
...
;;                   (tl-exists (sogg gv-ind-stat-sogg-sini) 
;;                       (:id-sini (tl-retrieve :id-sini sini) :id-sogg id :d-flg-respons "1" :d-flg-coinvolto "0" :d-flg-leso "0" :d-flg-richiedente "0" :d-flg-proprietario "0" :d-flg-contraente "0" :d-flg-deceduto "0" :d-flg-testimone "0"))))))))
