...
(defun random-sogg (&key id days (lesi 0) (delay) (fgvs 0) occurrences (decorr 0) (scad 0) (date (get-universal-time)))
                 ...
                 (tl-exists (sini gv-ind-stat-sini) 
                   ...
                   (tl-exists (veic gv-ind-stat-trg-veic-sini) 
                       (:id-sini (tl-retrieve :id-sini sini) :id-targa id
                                 :m-num-lesi (random-number 0 lesi)
                                 :m-num-rich-fgvs (random-number 0 fgvs)
                                 :m-anni-immatr (random-number 0 immatr)
                                 :m-num-incoerenze (random-number 0 incoer)
                                 :d-flg-targa-inesistente (tl-oneof nil "0" "1")
                                 :d-flg-fermo-admin (tl-oneof nil "0" "1")
...
(indicatore test-sco1 (soggetto) (durata occorrenze)
  (cond ((ind-ge (cluster (sinistri-soggetto soggetto (coinvolto-diretto t))
                      durata)
             occorrenze) (values t t))
        ((not (ind-ge (cluster (sinistri-soggetto soggetto (coinvolto-diretto nil)) 
                           durata)
...
(indicatore test-sco3 (soggetto) (durata occorrenze lesi)
  (cond ((ind-ge (cluster (sinistri-soggetto soggetto (and (ind-ge (numerolesi t) lesi)
                                              (coinvolto-diretto t)))
                      durata)
             occorrenze) (values t t))
        ((not (ind-ge (cluster (sinistri-soggetto soggetto (and (ind-ge (numerolesi nil) lesi)
...
(indicatore test-sco4 (soggetto) (durata occorrenze ritardo)
  (cond ((ind-ge (cluster (sinistri-soggetto soggetto (and (ind-ge (ind-minus (datadenuncia t) (dataaccadimento t)) (* ritardo 86400))
                                                  (coinvolto-diretto t)))
                          durata)
                 occorrenze) (values t t))
        ((not (ind-ge (cluster (sinistri-soggetto soggetto (and (ind-ge (ind-minus (datadenuncia nil) (dataaccadimento nil)) (* ritardo 86400))
                                                       (coinvolto-diretto nil))) 
                               durata)
                      occorrenze)) (values nil t))
        (t (values nil nil))))

(indicatore test-sco9 (soggetto) (durata occorrenze)
  (cond ((ind-ge (cluster (sinistri-soggetto soggetto (and (ind-ge (numerofgvs t) 0)
                                                  (coinvolto-diretto t)))
                          durata)
                 occorrenze) (values t t))
        ((not (ind-ge (cluster (sinistri-soggetto soggetto (and (ind-ge (numerofgvs nil) 0)
                                                  (coinvolto-diretto t))) 
                               durata)
                      occorrenze)) (values nil t))
        (t (values nil nil))))

(indicatore test-vei1 (veicolo) (durata occorrenze)
  (cond ((ind-ge (cluster (sinistri-veicolo veicolo)
                      durata)
             occorrenze) (values t t))
        ((not (ind-ge (cluster (sinistri-veicolo veicolo) 
                           durata)
                  occorrenze)) (values nil t))
        (t (values nil nil))))

(indicatore test-vei2 (veicolo) (durata occorrenze)
  (cond ((ind-ge (cluster (sinistri-veicolo veicolo)
                      durata)
             occorrenze) (values t t))
        ((not (ind-ge (cluster (sinistri-veicolo veicolo) 
...
(indicatore test-vei3 (veicolo) (durata occorrenze lesi)
  (cond ((ind-ge (cluster (sinistri-veicolo veicolo (and (ind-ge (numerolesi t) lesi)))
                      durata)
             occorrenze) (values t t))
        ((not (ind-ge (cluster (sinistri-veicolo veicolo (and (ind-ge (numerolesi nil) lesi))) 
                           durata)
                  occorrenze)) (values nil t))
        (t (values nil nil))))

(indicatore test-vei4 (veicolo) (durata occorrenze ritardo)
  (cond ((ind-ge (cluster (sinistri-veicolo veicolo (and (ind-ge (ind-minus (datadenuncia t) (dataaccadimento t)) (* ritardo 86400))))
                          durata)
                 occorrenze) (values t t))
        ((not (ind-ge (cluster (sinistri-veicolo veicolo (and (ind-ge (ind-minus (datadenuncia nil) (dataaccadimento nil)) (* ritardo 86400)))) 
                               durata)
                      occorrenze)) (values nil t))
        (t (values nil nil))))

(indicatore test-vei5 (veicolo) (durata occorrenze)
  (cond ((ind-ge (cluster (sinistri-veicolo veicolo (and (ind-ge (numerofgvs t) 0)))
                          durata)
                 occorrenze) (values t t))
        ((not (ind-ge (cluster (sinistri-veicolo veicolo (and (ind-ge (numerofgvs nil) 0))) 
                               durata)
                      occorrenze)) (values nil t))
        (t (values nil nil))))

(indicatore test-vei6 (veicolo) ()
  (cond ((veicoli veicolo (targaincoerente t)) (values t t))
        ((not (veicoli veicolo (targaincoerente nil))) (values nil t))
        (t (values nil nil))))
(indicatore test-vei7 (veicolo) ()
  (cond ((veicoli veicolo (targainesistente t)) (values t t))
        ((not (veicoli veicolo (targainesistente nil))) (values nil t))
        (t (values nil nil))))
...
(let ((sogg-res (apply #'append (loop for i from 101 to 110 collect
                                (let ((db (random-sogg :id i :days 180 :occurrences (1+ (random 3)) :lesi 5 :delay 20)))
                                  (multiple-value-bind (*sinistri-table* *soggetti-table*) 
                                      (flatten-db db)
                                    (tl-and db
                                            (test-ind 1 i test-sco1 (* 180 86400) 3)
                                            (test-ind 2 i test-sco2 (* 180 86400) 3)
                                            (test-ind 3 i test-sco3 (* 180 86400) 3 5)
                                            (test-ind 4 i test-sco4 (* 180 86400) 3 5)
                                            (test-ind 5 i test-sco4 (* 180 86400) 3 5)
                                            (test-ind 9 i test-sco9 (* 180 86400) 3)))))))
      (veic-res (apply #'append (loop for i from 101 to 102 collect
                                (let ((db (random-veic :id i :days 180 :occurrences (1+ (random 6)) :lesi 50 :delay 20 :fgvs 3 :immatr 10 :incoer 1)))
                                  (multiple-value-bind (*sinistri-table* *veicoli-table*) 
                                      (flatten-db db)
                                    (tl-and db
                                            (test-ind 11 i test-vei1 (* 180 86400) 3)
                                            (test-ind 12 i test-vei2 (* 180 86400) 3)
                                            (test-ind 13 i test-vei3 (* 180 86400) 2 4)
                                            (test-ind 14 i test-vei4 (* 180 86400) 2 4)
                                            (test-ind 15 i test-vei5 (* 180 86400) 2)
                                            (test-ind 16 i test-vei6)
                                            (test-ind 17 i test-vei7))))))))
