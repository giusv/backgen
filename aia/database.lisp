...
(indicatore test-sco4 (sinistro soggetto) (durata occorrenze ritardo)
  (cond ((ind-ge (cluster (sinistri-soggetto sinistro soggetto (and (ind-ge (ind-minus (datadenuncia t) (dataaccadimento t)) (* ritardo 86400))
                                                  (coinvolto-diretto t)))
                          durata)
                 occorrenze) (values t t))
        ((not (ind-ge (cluster (sinistri-soggetto sinistro soggetto (and (ind-ge (ind-minus (datadenuncia nil) (dataaccadimento nil)) (* ritardo 86400))
                                                       (coinvolto-diretto nil))) 
                               durata)
                      occorrenze)) (values nil t))
        (t (values nil nil))))
...
(indicatore test-sco9 (sinistro soggetto) (durata occorrenze)
  (cond ((ind-ge (cluster (sinistri-soggetto sinistro soggetto (and (ind-ge (numerofgvs t) 0)
                                                  (coinvolto-diretto t)))
                          durata)
                 occorrenze) (values t t))
        ((not (ind-ge (cluster (sinistri-soggetto sinistro soggetto (and (ind-ge (numerofgvs nil) 0)
                                                  (coinvolto-diretto t))) 
                               durata)
                      occorrenze)) (values nil t))
        (t (values nil nil))))
...
(indicatore test-vei4 (sinistro veicolo) (durata occorrenze ritardo)
...
(indicatore test-vei5 (sinistro veicolo) (durata occorrenze)
  (cond ((ind-gt (cluster (sinistri-veicolo sinistro veicolo (and (ind-ge (numerofgvs t) 0)))
                          durata)
                 occorrenze) (values t t))
        ((not (ind-gt (cluster (sinistri-veicolo sinistro veicolo (and (ind-ge (numerofgvs nil) 0))) 
                               durata)
                      occorrenze)) (values nil t))
        (t (values nil nil))))
...
(indicatore test-vei9 (sinistro veicolo) (durata occorrenze)
  (cond ((ind-gt (cluster (sinistri-veicolo sinistro veicolo (ind-ge (numeroincoerenzeveicolo t) 0))
                          durata)
                 occorrenze) (values t t))
        ((not (ind-gt (cluster (sinistri-veicolo sinistro veicolo (ind-ge (numeroincoerenzeveicolo nil) 0)) 
                               durata)
                      occorrenze)) (values nil t))
        (t (values nil nil))))
...
(let ((sogg-res (apply #'append (loop for i from 101 to 110 collect
                                     (let ((db (random-sogg :id i :days 180 :occurrences (1+ (random 3)) :lesi 5 :delay 20)))
                                       (multiple-value-bind (*sinistri-table* *soggetti-table*) 
                                           (flatten-db db) 
                                         (tl-and db
                                                 (test-ind-sogg 1 i i test-sco1 (* 180 86400) 3)
                                                 (test-ind-sogg 2 i i test-sco2 (* 180 86400) 3)
                                                 (test-ind-sogg 3 i i test-sco3 (* 180 86400) 3 5)
                                                 (test-ind-sogg 4 i i test-sco4 (* 180 86400) 3 5)
                                                 (test-ind-sogg 5 i i test-sco4 (* 180 86400) 3 5)
                                                 (test-ind-sogg 9 i i test-sco9 (* 180 86400) 3)))))))
      (veic-res (apply #'append (loop for i from 101 to 110 collect
                                     (let ((db (random-veic :id i :days 180 :occurrences (1+ (random 6)) :lesi 50 :delay 20 :fgvs 3 :immatr 10 :incoer 1)))
                                       (multiple-value-bind (*sinistri-table* *veicoli-table*) 
                                         ...
                                         (pprint `(case ,i))
                                         (pprint (car (field-values (veicoli i i) :m-anni-immatr)))
                                         (pprint (multiple-value-list (test-vei8 i i 5)))
                                         (pprint (veicoli i i))
                                         (tl-and db
                                                 (test-ind-veic 11 i i test-vei1 (* 180 86400) 3)
                                                 (test-ind-veic 12 i i test-vei2 (* 180 86400) 3)
                                                 (test-ind-veic 13 i i test-vei3 (* 180 86400) 2 4)
                                                 (test-ind-veic 14 i i test-vei4 (* 180 86400) 2 4)
                                                 (test-ind-veic 15 i i test-vei5 (* 180 86400) 2)
                                                 (test-ind-veic 16 i i test-vei6)
                                                 (test-ind-veic 17 i i test-vei7)
                                                 (test-ind-veic 18 i i test-vei8 5)
                                                 (test-ind-veic 19 i i test-vei9 (* 180 86400) 2))))))))
