...
;; (defent dwh-ind-stat-sogg-sini
;;     (entity 'dwh-ind-stat-sogg-sini
;;             :primary (attribute :dwh-ind-stat-sogg-sini-id (integer-type))
...
;; (defent dwh-ind-stat-trg-veic-sini
;;     (entity 'dwh-ind-stat-trg-veic-sini
;;             :primary (attribute :dwh-ind-stat-trg-veic-sini-id (integer-type))
;;             :fields (list (attribute :id-sini (integer-type) :desc "identificativo sinistro")
...
;; (defent dwh-ind-stat-sini
;;     (entity 'dwh-ind-stat-sini
;;             :primary (attribute :dwh-ind-stat-sini-id (integer-type))
