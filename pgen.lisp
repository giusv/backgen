...
;;   (:code (attribute) (java-concat (synth-all :code bindings attribute) 
  ...
  (:code (attribute lhs) 
         (if (is-terminal symbol)
             (if (and (synth :type symbol) lhs)
                 (java-concat (java-statement (java-pair lhs (synth :type symbol) 
...
(defprim push-environment ()
  ...
  (:code (attribute lhs) (java-concat (java-statement (java-pair 'saved (java-object-type 'env) :init (java-dynamic 'top)))
