...
(defprim java-annotation (name &optional content)
  (:pretty () (list 'java-annotation (list name name :content (synth :pretty content)))) 
  (:java () (hcat (text "@~a" name) 
...
(defprim java-concat (&rest statements)
  (:pretty () (list 'java-concat (list :statements (synth-all :pretty (apply #'append* statements))))) 
