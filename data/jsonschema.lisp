...
(defprim jsprop (name description content &rest validators)
  ...
  (:accessors (&optional suffix) 
              (list (java-method (symb "GET-" (upper-camel name)) nil (synth :type content suffix)
                                 (java-return (java-dynamic name)))
                    (java-method (symb "SET-" (upper-camel name)) (list (java-pair name (synth :type content suffix))) 
